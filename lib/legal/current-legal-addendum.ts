...
export const CURRENT_LEGAL_UPDATE = "16 de agosto de 2026";

export const currentTermsAddendum = {
  pt: {
    title: "15. Oferta de novos membros e faturação promocional — 16 de agosto de 2026",
    paragraphs: [
      ...
      "A aplicação do código promocional é controlada server-side e pela Stripe. A apresentação do código numa página ou mensagem promocional não garante, por si só, a aplicação do desconto se a promoção tiver expirado, sido desativada, atingido os respetivos limites ou se a conta não cumprir os critérios de elegibilidade.",
  ...
  en: {
    title: "15. New-member offer and promotional billing — August 16, 2026",
    paragraphs: [
      ...
      "Promotion-code application is controlled server-side and by Stripe. Displaying the code on a promotional page or message does not by itself guarantee the discount if the promotion has expired, been disabled, reached its limits, or the account does not meet the eligibility criteria.",
...
export const currentPrivacyAddendum = {
  pt: {
    title: "15. Atualização de tratamento — 16 de agosto de 2026",
    paragraphs: [
  ...
  en: {
    title: "15. Processing update — August 16, 2026",
    paragraphs: [
