...
export async function GET(request: Request) {
  try {
    ...
    const [shopsCount, usersCount, ownersCount, barbersCount, clientsCount, appointmentsCount, upcomingCount, activeSubscriptionsCount, assignmentsCount, allShops, shops, assignments, subscriptions] = await Promise.all([
