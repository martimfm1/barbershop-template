...
export default function MarketplacePage() {
  ...
  const [shops, setShops] = useState<Array<{ id: string; name: string; slug: string | null }>>([]);
  ...
  async function load() {
    ...
    try {
      ...
      if (!response.ok) throw new Error(json.error || 'Não foi possível carregar o marketplace.');
