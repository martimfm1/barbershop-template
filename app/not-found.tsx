          ...
          >
            <div className="rounded-2xl border border-white/10 bg-black/40 p-5 backdrop-blur-xl sm:p-8">
              <motion.div
                ...
                className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] uppercase tracking-[0.34em] text-zinc-300 backdrop-blur-xl sm:mb-8"
              >
                <Sparkles
                  className="size-3.5 shrink-0 text-zinc-100"
                  aria-hidden="true"
                />
              ...
              >
                ...
                <h1
                  className="select-none font-semibold leading-none tracking-[-0.06em]"
                  style={{
              ...
              >
                <h2 className="text-lg font-semibold tracking-[-0.03em] text-zinc-100 sm:text-xl">
                  {t('notFound.title')}
                </h2>
