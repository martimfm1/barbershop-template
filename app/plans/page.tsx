        ...
        <section className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[radial-gradient(circle_at_top_right,rgba(16,185,129,0.12),transparent_34%),rgba(24,24,27,0.72)] p-5 shadow-[0_30px_90px_rgba(0,0,0,0.24)] sm:p-8 lg:p-10">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-sm leading-6 text-zinc-400 sm:text-base">
              Começa no Free e sobe quando precisares de mais equipa, retenção,
              automação e controlo. O plano pertence à barbearia, não a cada
              utilizador.
            </p>
            <div className="mt-6 grid gap-2 text-xs text-zinc-500 sm:flex sm:flex-wrap sm:gap-x-5">
              ...
              <span className="inline-flex items-center gap-2">
                <CheckCircle2 className="size-3.5 text-emerald-300" />
                Membros da equipa herdam o plano
              </span>
              <span className="inline-flex items-center gap-2">
                <CheckCircle2 className="size-3.5 text-emerald-300" />
                Faturação com Stripe
              </span>
            </div>
          </div>
        </section>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-500">
                Compara funcionalidades e limites antes de decidir. Não precisas
                de decorar o que cada plano inclui.
              </p>
            </div>
            <Link
              href="/registo"
          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-2xl font-semibold tracking-[-0.04em] text-white">
                Começa no Free. Deixa o produto crescer contigo.
              </p>
              <p className="mt-2 text-sm leading-6 text-zinc-500">
                Podes gerir o plano e as faturas a partir das definições da tua
                barbearia.
              </p>
            </div>
            <Link
