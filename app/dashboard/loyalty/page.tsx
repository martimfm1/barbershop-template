...
export default function LoyaltyPage() {
  ...
  const saveSettings = async () => {
    ...
    try {
      ...
      toast.success(data.settings.enabled ? "Programa de fidelização ativado." : "Programa de fidelização desativado.");
