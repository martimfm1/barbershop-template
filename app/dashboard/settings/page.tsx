          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex min-w-0 items-center gap-3">
              <Link
                ...
                className="inline-flex size-10 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/[0.03] text-zinc-300 hover:bg-white/[0.06] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400"
              >
                <ArrowLeft className="size-4" />
              </Link>
              <div className="min-w-0">
                <p className="text-xs font-medium text-zinc-500">Painel</p>
            ...
            <div className="hidden items-center gap-2 sm:flex">
              {dirty && (
                <Button
                  ...
                  className="min-h-10 text-zinc-400 hover:text-zinc-100"
                >
                  Descartar
                </Button>
              )}
          ...
          <div className="min-w-0 lg:max-h-full lg:overflow-y-auto lg:pr-2">
            <div className="mb-4 flex gap-2 lg:hidden">
              ...
              <select
                ...
                value={mobileSection}
                onChange={(e) =>
                  selectSection(e.target.value as SettingsSection)
                }
                className="min-h-11 max-w-[46%] rounded-xl border border-white/10 bg-zinc-900 px-3 text-sm text-zinc-200"
              >
            ...
            <div className="mb-6 rounded-2xl border border-white/10 bg-white/[0.02] p-4 lg:hidden">
              <div className="flex items-center justify-between gap-3">
                <div>
                ...
                <div
                  className="size-12 rounded-full border-4 border-emerald-400/20 border-t-emerald-400"
                  aria-hidden="true"
                />
              </div>
            </div>
                ...
                <div className="grid lg:grid-cols-[1.15fr_.85fr]">
                  <div className="p-5 sm:p-7">
                    ...
                    <h2 className="mt-2 text-2xl font-semibold tracking-tight sm:text-3xl">
                      Tenha o essencial sempre pronto.
                    </h2>
                    <p className="mt-3 max-w-xl text-sm leading-6 text-zinc-500">
                      Encontre rapidamente uma definição, perceba o impacto da
                      alteração e continue o trabalho sem perder contexto.
                    </p>
                        ...
                        .map((section) => {
                          ...
                          return (
                            <button
                              ...
                              type="button"
                              onClick={() => selectSection(section.id)}
                              className="flex min-h-20 items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.02] p-4 text-left hover:bg-white/[0.05] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400"
                            >
                  ...
                  <div className="border-t border-white/10 bg-white/[0.02] p-5 sm:p-7 lg:border-l lg:border-t-0">
                    ...
                    <div className="mt-4 space-y-2">
                      <Link
                        ...
                        className="flex items-center justify-between rounded-xl border border-white/10 bg-black/20 p-3 hover:bg-white/[0.04]"
                      >
                        <span className="flex items-center gap-3">
                          <CreditCard className="size-4 text-zinc-400" />
                          <span className="text-sm">Gerir plano</span>
                        </span>
            ...
            <section id="settings-business" className="scroll-mt-24 mt-6">
              <Card className={CARD}>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Store className="size-4 text-emerald-400" /> Negócio
                  </CardTitle>
                  <CardDescription>
                    As informações que os clientes veem quando encontram a sua
                    barbearia.
                  </CardDescription>
                </CardHeader>
            ...
            <section id="settings-location" className="scroll-mt-24 mt-6">
              <SettingsLocationPanel barbershopId={barbershopId!} />
            </section>

            <section id="settings-hours" className="scroll-mt-24 mt-6">
              <Card className={CARD}>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Clock3 className="size-4 text-blue-400" /> Horários
                  </CardTitle>
                  <CardDescription>
                    Defina o horário de funcionamento e os dias em que a
                    barbearia está encerrada.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  <div>
                    <p className="text-sm font-medium">Dias de encerramento</p>
                    <div className="mt-3 grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                      {DAYS_OF_WEEK.map(([value, label]) => {
                        const active = currentClosedDays.includes(value);
                        return (
                          <button
                            key={value}
                            type="button"
            ...
            <section id="settings-appearance" className="scroll-mt-24 mt-6">
              <Card className={CARD}>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <ImageIcon className="size-4 text-amber-400" /> Aparência
                  </CardTitle>
                  <CardDescription>
                    Defina a identidade visual apresentada aos clientes.
                  </CardDescription>
                </CardHeader>
                      ...
                      <div className="absolute inset-x-4 bottom-4 flex items-end justify-between gap-3">
                        <div className="flex size-16 items-center justify-center overflow-hidden rounded-2xl border-2 border-zinc-950 bg-zinc-800 shadow-xl">
                          {avatarUrl ? (
                            ...
                            <UserCircle2 className="size-8 text-zinc-600" />
                          )}
                        </div>
            ...
            <section id="settings-booking" className="scroll-mt-24 mt-6">
              <Card className={CARD}>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                  ...
                  <CardDescription>
                    Escolha como os clientes podem interagir com a sua agenda.
                  </CardDescription>
                </CardHeader>
                  ...
                  <div className="flex items-center justify-between gap-4 rounded-2xl border border-white/10 bg-white/[0.02] p-4">
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 text-xs leading-5 text-zinc-600">
                        Quando ativo, os clientes podem marcar através da página
                        pública.
                      </p>
                    </div>
                    <Switch
            ...
            <section id="settings-billing" className="scroll-mt-24 mt-6">
                ...
                <CardContent className="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-zinc-500">
                      Veja o plano atual e altere-o quando precisar.
                    </p>
                  </div>
                  <Button
                    asChild
            ...
            <section id="settings-account" className="scroll-mt-24 mt-6">
              <Card className={CARD}>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <ShieldCheck className="size-4 text-emerald-400" /> Conta e
                    segurança
                  </CardTitle>
                  <CardDescription>
                    Gestão da sessão e acesso à conta.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Button
          ...
          <div className="fixed inset-x-0 bottom-0 z-40 border-t border-white/10 bg-zinc-950/95 p-3 backdrop-blur-xl sm:hidden">
            <div className="mx-auto flex max-w-xl items-center gap-2">
              <Button
                ...
                variant="ghost"
                onClick={cancelChanges}
                className="min-h-11 flex-1 text-zinc-400"
              >
                Descartar
              </Button>
              <Button
                ...
                onClick={() => void saveSettings()}
                disabled={saving}
                className="min-h-11 flex-[1.4] rounded-xl bg-zinc-50 text-zinc-950"
              >
                {saving ? (
                  <Spinner className="mr-2 size-4" />
                ) : (
