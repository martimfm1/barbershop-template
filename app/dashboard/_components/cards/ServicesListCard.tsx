...
const item =
  'rounded-xl border border-white/10 bg-white/[0.025] transition-colors duration-200 hover:border-white/20 hover:bg-white/[0.045]';
const iconButton =
  ...
  return (
    <Card className={shell}>
      ...
      <CardContent className="p-5 sm:p-6">
            ...
            <div className="mb-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-5 text-zinc-500">
                  Começa com um serviço, preço e duração. Podes acrescentar o
                  resto depois.
                </p>
              </div>
            </div>
        ...
        {services.length === 0 ? (
          <div className="silentra-empty rounded-xl text-center">
            <div className="flex flex-col items-center px-5 py-12 sm:py-14">
              <div className="flex size-12 items-center justify-center rounded-xl border border-amber-500/20 bg-amber-500/[0.04] text-amber-400">
                <Scissors className="size-5" />
              </div>
              ...
              <p className="mx-auto mt-1 max-w-md text-sm leading-6 text-zinc-500">
                Não precisas de criar o menu todo. Adiciona primeiro o serviço
                mais procurado e começa a receber marcações.
              </p>
              <Button
                onClick={() => setShowAddServiceForm(true)}
                className="mt-5 min-h-11 bg-zinc-50 text-zinc-950 hover:bg-white"
              >
                <Plus className="mr-2 size-4" />
              ...
              >
                <div>
                  ...
                  <div className="mt-4 flex items-center gap-2 text-xs text-zinc-500">
                    ...
                    {service.duration ?? (service as any).min_duration ?? '—'}{' '}
                    min
                  </div>
                </div>
                <div className="mt-4 flex justify-end gap-1 border-t border-white/5 pt-3">
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent className="border-white/10 bg-zinc-950">
                      <AlertDialogHeader>
                        <AlertDialogTitle>
                          Eliminar este serviço?
                        </AlertDialogTitle>
                        <AlertDialogDescription>
                          As marcações existentes não devem ser alteradas.
                          Confirma apenas se já não precisas deste serviço.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
