...
export default function EmailConfirmationErrorPage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-zinc-950 px-4 py-8 text-zinc-100">
      ...
      >
        <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-full bg-red-500/10 text-red-400" aria-hidden="true">
          <AlertCircle className="h-6 w-6" />
        </div>

        <h1 id="confirmation-error-title" className="text-2xl font-semibold tracking-tight">
          Não foi possível confirmar o teu e-mail
        </h1>
        <p className="mt-3 text-sm leading-6 text-zinc-400">
          O link de confirmação pode ter expirado, já ter sido utilizado ou não ser válido.
          Pede um novo e-mail de confirmação e tenta novamente.
        </p>
        ...
        <p className="mt-6 text-center text-xs leading-5 text-zinc-500">
          Se continuares com problemas, verifica se estás a utilizar o e-mail de confirmação mais recente.
        </p>
      </section>
    </main>
  );
