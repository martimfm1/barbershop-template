...
const agendaItems = [
  ...
  },
  {
    time: '11:30',
    name: 'Slot Bloqueado',
    service: 'Motivo: Almoço da Equipa',
    meta: 'Horário protegido',
    state: 'blocked',
  },
  {
    time: '13:30',
    name: 'Rui',
    service: 'Acabamento / Pezinho',
    meta: 'Lembrete automático enviado',
    state: 'active',
  },
] as const;
...
const outreach = [
  {
    icon: MessageSquare,
    title: 'Lembrete enviado a João',
    detail: 'Há 15m · Estado: Entregue',
  },
  {
    icon: MailCheck,
    title: 'Pedido de avaliação enviado a Marcus',
    detail: 'Há 2h · Estado: Clicado',
  },
] as const;
    ...
    <section id="command-center" className="space-y-7">
      <div className="flex items-end justify-between gap-4">
        ...
        <p className="hidden max-w-sm text-sm leading-6 text-zinc-500 md:block">
          Marcações, faturação, fila de espera e notificações automáticas numa
