...
export function ProTrialBanner() {
  return (
    <section className="mx-auto max-w-7xl px-4 pt-24 sm:px-6 lg:px-8" aria-label="Oferta de um mês Barbers Pro">
        ...
        <div className="relative flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              <p className="text-sm font-semibold text-emerald-100">1 mês de Barbers Pro grátis</p>
              <p className="mt-0.5 text-xs leading-5 text-zinc-400">Oferta exclusiva para novos utilizadores. O código TRIALPRO dá acesso ao primeiro mês sem cobrança.</p>
            </div>
          </div>
          <Link
            href="/registo"
