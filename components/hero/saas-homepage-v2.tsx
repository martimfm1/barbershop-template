...
function SectionHeading({
  ...
  return (
    <div className="max-w-2xl">
      ...
      <h2 className="mt-3 text-3xl font-semibold leading-tight tracking-[-0.05em] text-white sm:text-5xl">
        {title}
      </h2>
    ...
    <main className="relative mt-24 overflow-hidden">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:gap-16">
          <div>
            <div className="inline-flex items-center gap-2 border border-white/10 bg-white/[0.04] px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.22em] text-zinc-300">
              ...
              Software perfeito para as barbearias
            </div>
            <h1 className="mt-6 max-w-3xl text-[2.8rem] font-semibold leading-[0.97] tracking-[-0.065em] text-white sm:text-6xl lg:text-7xl">
              A barbearia organizada para o cliente voltar.
            </h1>
            <p className="mt-6 max-w-xl text-[15px] leading-7 text-zinc-400 sm:text-lg">
              Reservas, agenda, equipa, clientes e crescimento no mesmo sistema.
              Simples para o cliente; poderoso para quem gere.
            </p>
            <div className="mt-7 grid gap-3 sm:flex sm:flex-wrap">
              ...
              >
                Criar barbearia grátis <ArrowRight className="size-4" />
              </Link>
              <Link
                href="/barbershops"
            ...
            <div className="mt-6 grid gap-2 text-xs text-zinc-500 sm:flex sm:flex-wrap sm:gap-x-5">
              ...
              <span className="inline-flex items-center gap-2">
                <Check className="size-3.5 text-emerald-300" />
                Cliente pode reservar sem conta
              </span>
            </div>
          </div>
            ...
            <div className="relative border border-white/10 bg-zinc-900/80 p-2.5 shadow-[0_35px_110px_rgba(0,0,0,0.45)] backdrop-blur-xl sm:p-3">
              <div className="border border-white/10 bg-black/25 p-4 sm:p-5">
                <div className="flex items-start justify-between gap-4 border-b border-white/8 pb-4">
                  ...
                  <span className="inline-flex shrink-0 items-center gap-1.5 border border-emerald-400/15 bg-emerald-400/[0.07] px-2.5 py-1 text-[11px] text-emerald-200">
                ...
                <div className="mt-5 border-t border-white/8 pt-4">
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Link
                      href="/barbershops"
                      className="inline-flex min-h-11 items-center justify-center gap-2 bg-white px-4 text-sm font-semibold text-zinc-950"
                    >
              ...
              <div className="mt-2 grid grid-cols-3 gap-2">
                {["Serviço", "Horário", "Confirmação"].map((item, index) => (
                  ...
                  >
                    <span className="mr-1.5 text-emerald-300">
                      0{index + 1}
                    </span>
                    {item}
                  </div>
      ...
      <section className="border-y border-white/8 bg-white/[0.015]">
        <div className="mx-auto grid max-w-7xl md:grid-cols-3">
          <div className="px-4 py-7 sm:px-6 md:px-6 lg:px-8">
            <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-zinc-500">
              Cliente
            </p>
            <p className="mt-2 text-sm leading-6 text-zinc-300">
              Reserva sem conta e gestão das marcações através do email.
            </p>
          </div>
          <div className="border-t border-white/8 px-4 py-7 sm:px-6 md:border-l md:border-t-0 md:px-6 lg:px-8">
            <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-zinc-500">
              Equipa
            </p>
            <p className="mt-2 text-sm leading-6 text-zinc-300">
          ...
          <div className="border-t border-white/8 px-4 py-7 sm:px-6 md:border-l md:border-t-0 md:px-6 lg:px-8">
            ...
            <p className="mt-2 text-sm leading-6 text-zinc-300">
              Fidelização, marketing, automações e estatísticas para crescer.
            </p>
          </div>
        </div>
      </section>

      <section className="mx-auto max-w-7xl px-4 py-18 sm:px-6 sm:py-24 lg:px-8">
        <SectionHeading
          eyebrow="Produto"
          title="Tudo o que a operação precisa, numa única linguagem visual."
          text="O Silentra liga a experiência pública do cliente à operação privada da barbearia. Sem ferramentas espalhadas, sem estados duplicados e sem esconder a complexidade onde ela realmente importa."
        />
      ...
      <section className="mx-auto grid max-w-7xl gap-4 px-4 pb-18 sm:px-6 sm:pb-24 lg:grid-cols-2 lg:px-8">
        <article className="border border-white/10 bg-zinc-900/45 p-5 sm:p-8">
          <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-zinc-500">
            Depois da reserva
          </p>
          <h2 className="mt-3 text-2xl font-semibold tracking-[-0.04em] text-white sm:text-3xl">
            A relação não acaba no botão “confirmar”.
          </h2>
          <div className="mt-7 space-y-3">
            {[
              ...
              <div
                key={text}
                className="flex gap-3 border border-white/8 bg-black/20 p-4 text-sm leading-6 text-zinc-300"
              >
          ...
          <Link
            href="/my-bookings"
            className="mt-7 inline-flex min-h-11 items-center gap-2 text-sm font-semibold text-white hover:text-emerald-200"
          >
            Gerir uma marcação <ArrowRight className="size-4" />
          </Link>
        </article>
        <article className="border border-white/10 bg-zinc-900/45 p-5 sm:p-8">
          <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-zinc-500">
          ...
          <h2 className="mt-3 text-2xl font-semibold tracking-[-0.04em] text-white sm:text-3xl">
            O plano pertence à barbearia. O acesso pertence às permissões.
          </h2>
          <div className="mt-7 space-y-3">
            {[
      ...
      <section className="mx-auto max-w-7xl px-4 pb-18 sm:px-6 sm:pb-24 lg:px-8">
        <SectionHeading
          eyebrow="Planos"
          title="Começa simples e cresce sem trocar de sistema."
          text="O plano é definido pela barbearia e acompanha toda a equipa. Escolhe pela fase do negócio, não pela quantidade de logins."
        />
              ...
              >
                ...
                {isDisabled ? (
                  <button
                    type="button"
                    disabled
                    className="mt-7 inline-flex min-h-11 w-full cursor-not-allowed items-center justify-center gap-2 border border-white/10 bg-white/5 text-sm font-semibold text-zinc-400 opacity-60"
                  >
                    {label}
                  </button>
                ) : (
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 sm:pb-20 lg:px-8">
        <div className="border border-white/10 bg-white/[0.03] p-6 sm:p-8 lg:p-10">
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-semibold tracking-[-0.05em] text-white sm:text-4xl">
                Organiza a operação antes que a operação te organize a ti.
              </h2>
              <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-400">
                Cria a barbearia, configura a equipa e começa a receber
                reservas. Os clientes podem reservar sem criar uma conta.
              </p>
            </div>
            <div className="grid gap-2 sm:flex lg:grid">
              ...
              <Link
                href="/my-bookings"
                className="inline-flex min-h-12 items-center justify-center gap-2 border border-white/10 bg-white/[0.04] px-5 text-sm font-semibold text-white"
              >
                Gerir uma marcação
              </Link>
            </div>
