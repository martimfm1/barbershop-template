...
export function SaaSHomepageV2() {
  ...
  return (
    <main className="relative overflow-hidden mt-24">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-18 sm:px-6 sm:pb-24 lg:px-8">
        ...
        <div className="mt-10 grid gap-3 lg:grid-cols-3">
          {plans.map((plan) => (
            <article
              key={plan.name}
              className={`relative border p-5 sm:p-6 ${plan.recommended ? "border-emerald-400/30 bg-emerald-400/[0.055]" : "border-white/10 bg-zinc-900/35"}`}
            >
              {plan.recommended ? (
