    ...
    <section id="precos" className="space-y-7">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-[-0.04em] text-zinc-50 sm:text-4xl">Começa grátis. Paga apenas quando o Silentra começar a dar-te mais valor.</h2>
          <p className="mt-3 max-w-xl text-sm leading-6 text-zinc-400 sm:text-base">Configura a tua operação sem cartão e faz upgrade quando precisares de automação, crescimento e mais controlo.</p>
        </div>
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <div className="border border-white/10 bg-white/[0.025] px-5 py-4"><p className="flex items-center gap-2 text-sm font-semibold text-zinc-100"><Check className="size-4 text-emerald-400" /> Sem risco para começar</p><p className="mt-1 text-xs leading-5 text-zinc-500">Sem cartão e sem período experimental obrigatório.</p></div>
        <div className="border border-emerald-500/20 bg-emerald-500/[0.045] px-5 py-4"><p className="text-sm font-semibold text-emerald-300">Pro para crescer</p><p className="mt-1 text-xs leading-5 text-zinc-500">Poupa trabalho repetitivo e cria mais oportunidades de retorno.</p></div>
