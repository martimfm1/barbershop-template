...
-- Keep appointment creation aligned with the canonical appointment_status enum:
-- pending | scheduled | completed | cancelled.
-- The previous function referenced the legacy value `confirmed` in both its
-- status normalization and conflict predicate, which causes PostgreSQL to
-- raise 22P02 when the enum does not contain that value.
