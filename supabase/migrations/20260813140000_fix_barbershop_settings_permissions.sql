-- Centralise barbershop settings writes in a narrowly scoped SECURITY DEFINER RPC.
-- The browser never receives service_role privileges and the function only allows
-- the authenticated owner/admin of the target tenant to update whitelisted fields.
