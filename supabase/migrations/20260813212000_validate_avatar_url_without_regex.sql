-- Avoid PostgreSQL regexp escape ambiguity while validating the exact tenant
-- path generated by Supabase Storage.
...
begin
  ...
  if position(
    '/storage/v1/object/public/avatar/' || p_barbershop_id::text || '/avatar.webp'
    in p_avatar_url
  ) = 0 then
