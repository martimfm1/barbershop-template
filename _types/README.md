...
- `marketplace/shops.ts`: database, API, and presentation shop models.
- `marketplace/filters.ts`: directory filters and coordinate data.
- `marketplace/booking.ts`: booking-flow data and hook contracts.
- `marketplace/components.ts`: marketplace component props.
